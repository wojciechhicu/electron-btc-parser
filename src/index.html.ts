...
document.addEventListener("DOMContentLoaded", () => {
	...
	function closeWindow() {
        ...
        function initCheck(){
                ...
                ipcRenderer.on('checkConfigResponse', (event, arg: appConfig) =>{
                        arg.blocksDirPath === "" ? navigateTo('./views/home/home') : navigateTo('./views/parser/parser')
                })
        }
